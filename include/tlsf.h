...
extern size_t init_memory_pool(int, size_t, void *);
extern void *tlsf_calloc(int, size_t nelem, size_t elem_size);
extern void *tlsf_realloc(int, void *ptr, size_t size);
extern void tlsf_free(int, void *ptr);
extern void *tlsf_malloc(int, size_t size);
